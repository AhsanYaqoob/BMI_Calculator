...
public class EER_Activity extends AppCompatActivity {
        ...
        cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(lightc==1){
                    ...
                    double v1 = (9.36 * w) + (726 * (h / 100));
                    double eer = 354 - (6.91 * a) + (1.2) * v1;
                    result.setText(String.valueOf(eer));

                }
                else if(moderatc==1){

                    double v1 = (9.36 * w) + (726 * (h / 100));
                    double eer = 354 - (6.91 * a) + (1.55) * v1;
                    result.setText(String.valueOf(eer));
